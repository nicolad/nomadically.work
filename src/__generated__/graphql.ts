...
export type GetJobsQuery = { __typename: 'Query', jobs: { __typename: 'JobsResponse', totalCount: number, jobs: Array<{ __typename: 'Job', id: number, external_id: string, source_kind: string, company_key: string, title: string, location: string | null, url: string, posted_at: string, status: JobStatus | null, is_remote_eu: boolean, remote_eu_confidence: ClassificationConfidence | null, skills: Array<{ __typename: 'JobSkill', tag: string, level: string }> | null }> } };
...
export type GetGreenhouseJobsQuery = { __typename: 'Query', jobs: { __typename: 'JobsResponse', totalCount: number, jobs: Array<{ __typename: 'Job', id: number, external_id: string, source_id: string | null, source_kind: string, company_id: number | null, company_key: string, title: string, location: string | null, url: string, description: string | null, posted_at: string, score: number | null, score_reason: string | null, is_remote_eu: boolean, remote_eu_confidence: ClassificationConfidence | null, remote_eu_reason: string | null, created_at: string, updated_at: string, company: (
        { __typename: 'Company' }
        & { ' $fragmentRefs'?: { 'CompanyFieldsFragment': CompanyFieldsFragment } }
