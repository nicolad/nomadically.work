                    ...
                    <Box
                      ...
                      style={{
                        ...
                        borderLeft: `3px solid ${
                          ex.difficulty === "easy" ? "var(--green-9)" :
                          ex.difficulty === "medium" ? "var(--amber-9)" :
                          "var(--red-9)"
                        }`,
                      }}
                    >
                      ...
                      <Box>
                        <Button
                          ...
                          variant="soft"
                          color="violet"
                          onClick={() => setAgenticExerciseOpen(agenticExerciseOpen === i ? null : i)}
                        >
                          {agenticExerciseOpen === i ? "Hide agent prompt" : "Show agent prompt"}
                        </Button>
                        {agenticExerciseOpen === i && (
                          <Box mt="2" p="3" style={{ backgroundColor: "var(--gray-3)", borderRadius: "var(--radius-2)", position: "relative" }}>
                            <Flex justify="between" align="center" mb="2">
                              <Text size="1" color="gray" weight="medium">Claude Code / Cursor prompt</Text>
                              <Button
                                size="1"
                                variant="ghost"
                                color={copiedPrompt === i ? "green" : "gray"}
                                onClick={() => {
                                  navigator.clipboard.writeText(ex.agentPrompt);
                                  setCopiedPrompt(i);
                    ...
                    <Flex key={i} align="start" gap="2" p="3" style={{ backgroundColor: "var(--gray-2)", borderRadius: "var(--radius-2)" }}>
                      <Box style={{ flex: 1 }}>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          style={{ color: "var(--accent-11)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 4 }}
                        >
