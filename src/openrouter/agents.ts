...
export const agentTemplates = {
   ...
   */
  assistant: (instructions?: string) => createChatAgent({
    name: 'Assistant',
   ...
   */
  reasoning: (instructions?: string) => createReasoningAgent({
    name: 'Reasoning Assistant',
    instructions: instructions || 'You are a reasoning assistant. Think through problems step by step.',
  }),

  /**
   * Coding agent using DeepSeek Coder
   */
  coder: (instructions?: string) => createCodingAgent({
    name: 'Coding Assistant',
    instructions: instructions || 'You are an expert coding assistant specialized in software development.',
  }),
} as const;
