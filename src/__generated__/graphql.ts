...
export type ApplicationFieldsFragment = { __typename: 'Application', id: number, email: string, jobId: string, resume: File | null, status: ApplicationStatus, notes: string | null, jobTitle: string | null, companyName: string | null, jobDescription: string | null, createdAt: string, questions: Array<{ __typename: 'QuestionAnswer', questionId: string, questionText: string, answerText: string }>, interviewPrep: Array<{ __typename: 'Track', id: string, slug: string, title: string, description: string | null, level: string | null }>, aiInterviewPrep: { __typename: 'AIInterviewPrep', summary: string, generatedAt: string, requirements: Array<{ __typename: 'AIInterviewPrepRequirement', requirement: string, questions: Array<string>, studyTopics: Array<string>, sourceQuote: string | null, deepDive: string | null }> } | null } & { ' $fragmentName'?: 'ApplicationFieldsFragment' };
